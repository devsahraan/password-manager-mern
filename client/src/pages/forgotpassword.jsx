...
function Forgotpassword() {
  ...
  let forgetpass = (email) => {
    ...
    if (email != "") {
      ...
      fetch("http://localhost:3000/user/forgetpassword", requestOptions)
        ...
        .then((result) => {
          ...
          if (data.status == "failed") {
            ...
            setLoading(false);
            navigate("/verifyotp" ,{replace : "true" , state : {email : email , forget : true}})
          }
        })
        .catch((error) =>{
    ...
    <section className="flex justify-center items-center h-[100vh] w-[100%]">
      <div className="center-box rounded-md  w-[30%] h-[fit-content] pb-[15px] pt-[15px]">
        ...
        <div className="pr-3 pl-3">
          <button onClick={()=> forgetpass(email)} className="rounded-lg w-[100%] h-[49px] bg-black flex justify-center items-center">
            <span className="text-white font-bold">Find Account</span>
           {
             showLoading ? <span>
