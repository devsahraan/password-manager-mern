  ...
  return (
    <section className="flex justify-center items-center h-[100vh] w-[100%]">
      <div className="center-box rounded-md  w-[30%] h-[fit-content] pb-[15px] pt-[15px]">
        ...
        <div className="pr-3 pl-3 pb-3 font-semibold flex justify-end">
          <Link to={"/forgotpassword"}>Forgot Password</Link>
        </div>
        <div className="pr-3 pl-3">
          <button
            onClick={() => login(email, password)}
            className="rounded-lg w-[100%] h-[49px] bg-black flex justify-center items-center"
          >
            <span className="text-white font-bold">Login {
                showLoading ? <span>
              <svg aria-hidden="true" role="status" class="inline w-6 h-6 me-0 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
